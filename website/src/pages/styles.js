...
`}</pre>
            ...
            <div className='section' style={{marginTop: '40px'}}>
                <h1>Lightbox</h1>
                <pre>{`<Lightbox src="/img/jinjat-logo.svg" title="The Jinjat logo" />`}</pre>
                <Lightbox src="/img/jinjat-logo.svg" title="The Jinjat logo" />
            </div>

            <div className='section' style={{marginTop: '40px'}}>
                <h1>Markdown Links</h1>
                  Refer to the <Link href="https://github.com/jinjat-data/jinjat.com/blob/current/contributing/content-style-guide.md#Links">Links section</Link> of the Content Style Guide to read about how you can use links in the dbt product documentation.
            </div>
